...
<img src="04-nuage-point_files/figure-epub3/first-scatterplot-1.png" alt="Exemple de graphique en nuage de points. Des éléments essentiels sont ici mis en évidence en couleurs (voir texte). \label{np_intro}"  />
...
```r
DT::datatable(urchin , filter = 'top', class = c('compact', 'cell-border'), rownames = FALSE)
```
...
<img src="04-nuage-point_files/figure-epub3/unnamed-chunk-5-1.png" style="display: block; margin: auto;" />
...
<div class="figure" style="text-align: center">
<img src="04-nuage-point_files/figure-epub3/unnamed-chunk-12-1.png" alt="Piège du nuage de points. A) graphique initial montrant la variation de la hauteur [mm] en fonction de la masse [g]. B) graphique A avec la modification de l'échelle de l'axe X. C) Graphique A avec une seconde modification de l'axe X. D) Graphique A avec modification simultanée des deux axes."  />
<p class="caption">(\#fig:unnamed-chunk-12)Piège du nuage de points. A) graphique initial montrant la variation de la hauteur [mm] en fonction de la masse [g]. B) graphique A avec la modification de l'échelle de l'axe X. C) Graphique A avec une seconde modification de l'axe X. D) Graphique A avec modification simultanée des deux axes.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="04-nuage-point_files/figure-epub3/unnamed-chunk-13-1.png" alt="A) Hauteur [mm] en fonction de la masse [g] d'oursins violets. B) Logarithme en base 10 de la hauteur [mm] en fonction du logarithme en base 10 de la masse [g] de ces mêmes oursins."  />
<p class="caption">(\#fig:unnamed-chunk-13)A) Hauteur [mm] en fonction de la masse [g] d'oursins violets. B) Logarithme en base 10 de la hauteur [mm] en fonction du logarithme en base 10 de la masse [g] de ces mêmes oursins.</p>
</div>
