...
{\centering \includegraphics{04-nuage-point_files/figure-latex/first-scatterplot-1} 

}

\caption{Exemple de graphique en nuage de points. Des éléments essentiels sont ici mis en évidence en couleurs (voir texte). \label{np_intro}}(\#fig:first-scatterplot)
\end{figure}
...
\begin{center}\includegraphics{04-nuage-point_files/figure-latex/unnamed-chunk-5-1} \end{center}
...
```
# Retrouvez la vidéo via le lien suivant : https://www.youtube.com/watch?v=-QzG3Xr202w
```
...
```
# Retrouvez une séance d'exercice via une application shiny 
...
{\centering \includegraphics{04-nuage-point_files/figure-latex/unnamed-chunk-12-1} 

}

\caption{Piège du nuage de points. A) graphique initial montrant la variation de la hauteur [mm] en fonction de la masse [g]. B) graphique A avec la modification de l'échelle de l'axe X. C) Graphique A avec une seconde modification de l'axe X. D) Graphique A avec modification simultanée des deux axes.}(\#fig:unnamed-chunk-12)
\end{figure}
...
{\centering \includegraphics{04-nuage-point_files/figure-latex/unnamed-chunk-13-1} 

}

\caption{A) Hauteur [mm] en fonction de la masse [g] d'oursins violets. B) Logarithme en base 10 de la hauteur [mm] en fonction du logarithme en base 10 de la masse [g] de ces mêmes oursins.}(\#fig:unnamed-chunk-13)
\end{figure}
...
```
# Retrouvez une séance d'exercice lié à une vidéo 
